...
const SolutionsPage = ()=> {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            ...
            const fetchedOptions = await Option.getOptionsForQuestion(question.Qu_Id);
    ...
    // let [option1 , option2, option3, option4] = options; 
    ...
    <div class="w-[385px] h-[393px] mx-6 mb-10   relative">
        ...
        <div class="w-[124px] h-[39px] left-[15px] top-[6px] absolute text-stone-300 text-3xl font-normal font-['Comic Sans MS']">Option1</div>
        </div>
        <div class="w-[311.72px] h-[59px] left-[22px] top-[213px] absolute">
            ...
            <div class="w-[124px] h-[39px] left-[15px] top-[6px] absolute text-stone-300 text-3xl font-normal font-['Comic Sans MS']">option2</div>
        </div>
        <div class="w-[311.72px] h-[125px] left-[22px] top-[137px] absolute">
            ...
            <div class="w-[124px] h-[39px] left-[15px] top-[6px] absolute text-stone-300 text-3xl font-normal font-['Comic Sans MS']">option3</div>
        ...
        <div class="w-[311.72px] h-[59px] left-[22px] top-[61px] absolute">
            ...
            <div class="w-[124px] h-[39px] left-[15px] top-[6px] absolute text-stone-300 text-3xl font-normal font-['Comic Sans MS']">option4   </div>
        </div>
        <div class="w-[51px] h-[39px] left-[333px] top-[71px] absolute text-center text-black text-base font-normal font-['Comic Sans MS']"></div>
        <div class="w-[51px] h-[39px] left-[334px] top-[150px] absolute text-center text-black text-base font-normal font-['Comic Sans MS']"></div>
        <div class="w-[51px] h-[39px] left-[334px] top-[221px] absolute text-center text-black text-base font-normal font-['Comic Sans MS']"></div>
        <div class="w-[51px] h-[39px] left-[333px] top-[299px] absolute text-center text-black text-base font-normal font-['Comic Sans MS']"></div>
    </div>
