const StudentSolutionsPage = ()=>{
    ...
    <img class="w-24 h-24 self-center mt-5" src="utils/icons/wrongIcon.png" />
    <div class="w-[7px] h-[41px] bg-neutral-400 rounded-[20px] "></div>
    <div class="w-[340px] h-7 text-center text-stone-300 text-xl font-normal font-['Comic Sans MS']">Your answer was wrong<br/></div>
    <div class="w-[385px] h-[393px] mx-6 mb-10 relative">
        <div class="w-[385px] h-[393px] left-0 top-0 absolute bg-lime-300 rounded-[40px]"></div>
        ...
        <div class="w-[311.72px] h-[59px] left-[22px] top-[213px] absolute">
            ...
            <img class="w-[38.14px] h-10 left-[262px] top-[8px] absolute" src="utils/icons/wrongIcon.png" />
        </div>
        <div class="w-[311.72px] h-[59px] left-[22px] top-[137px] absolute">
            <div class="w-[311.72px] h-[58.60px] left-0 top-0 absolute bg-neutral-800 bg-opacity-40 rounded-[20px]"></div>
            ...
            <img class="w-10 h-10 left-[262px] top-[9px] absolute" src="utils/icons/correctIcon.png" />
        </div>
    ...
    <div class="w-56 h-[58px] text-center self-center mb-20 mt-20  text-stone-300 text-[40px] font-normal font-['Comic Sans MS']">Explanation</div>
    <div class="w-[430px] h-[77px] mt-10  relative">
        <div class="w-[430px] h-[77px] left-0 top-0 absolute bg-neutral-800"></div>
        {/* <img class="w-12 h-12 left-[23px] top-[14px] absolute" src="https://via.placeholder.com/48x48" /> */}
    </div>
</div>
</div>  
    )
